...
interface Props {
  ...
  favorites: number[]
  onToggleFavorite: (tech: Technician) => void
  onOpen: (id: number) => void
  onNavigate: (screen: 'messages' | 'profile') => void
}

export function HomeScreen({ technicians, favorites, onToggleFavorite, onOpen, onNavigate }: Props) {
