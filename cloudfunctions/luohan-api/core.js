...
function presentOrder(o) { return { id: o.id, techId: o.technicianId, serviceId: o.serviceId, dateLabel: o.dateLabel, time: beijingSlot(o.appointmentAt).split('|')[1], intensity: o.intensity, paymentMethod: o.paymentMethod, status: o.status === 'CANCELLED' ? 6 : statuses.indexOf(o.status), etaSeconds: o.etaSeconds, address: { id: 'saved', label: o.addressLabel, detail: o.addressDetail }, note: o.note, originalPrice: o.originalPrice, discount: o.discount, paidAmount: o.paidAmount, couponLabel: o.couponLabel, reviewed: o.reviewed, reviewRating: o.reviewRating || undefined } }
